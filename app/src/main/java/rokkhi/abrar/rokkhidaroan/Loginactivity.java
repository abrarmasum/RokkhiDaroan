...
import rokkhi.abrar.rokkhidaroan.Login.InsideApp;
...
public class Loginactivity extends AppCompatActivity implements
    ...
    private String mVerificationId,initial_contact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
            ...
            serial=intent.getIntExtra("daroanno",0);
            mobile=intent.getStringExtra("daroanmobile");
            initial_contact = "+88"+ extras.getString("contact1");
            from=intent.getStringExtra("from");
            if(from.equals("ServiceRequestActivity")){
                initial_contact = "+88"+ intent.getStringExtra("contact1");
            }
            else{
                initial_contact="+88"+ mobile;
            }
        ...
        mPhoneNumberField.setText(initial_contact);
...
//                if(from.equals("ServiceRequestActivity"))mStatusText.setText("Thank you.Our agent will contact with you soon!");
//                else{
//                    Intent intent=new Intent(this,InsideApp.class);
//                    startActivity(intent);
//                }

                //mStatusText.setText("Thank you.Our agent will contact with you soon!");


//                                AlertDialog.Builder builder = new AlertDialog.Builder(Loginactivity.this);
//                                builder.setMessage("Our agent will contact with you soon to confirm your identity.")
//                                        .setPositiveButton("okay", new DialogInterface.OnClickListener() {
//                                            public void onClick(DialogInterface dialog, int id) {
//                                                Intent intent=new Intent(Loginactivity.this,Startingpage.class);
//                                                startActivity(intent);
//                                                // FIRE ZE MISSILES!
//                                            }
//                                        }).show();
            ...
            */
            ...
            if(from!=null && !from.equals("")){
                if(from.equals("ServiceRequestActivity")){
                    ...
                    intent.putExtra("daroanno",mobile);
                    intent.putExtra("koitheke",TAG);
                    startActivity(intent);
                    finish();
                }
            }
